          ...
          <div style={{overflow:'hidden', width: '100%', height: '100%' }}>
            <div
              style={{
                ...
                backgroundImage: `url(./pic/banner2.jpg)`,
                backgroundSize: `cover`,
                backgroundPosition: `50% 50%`
              }}
            />
            <div
              style={{ width: '100%', height: '100%', left: 0, top: '-100%', alignItems:'center', justifyContent:'center' }}>
              <div style={{ height: '2rem' }} />
              <p style={{ transform:`translate(0%, ${mot.titleY}px)`,fontSize: this.state.pc?40:24, color: '#fff', fontWeight: 600, textShadow:'0 0.2rem 0.2rem rgba(0, 0, 0, 0.15)', }}>
              女性为什么会得宫颈癌？
              </p>
              <CpArrowButton to='#/nav/newbanner2/' style={{ transform: `translate(0%, ${mot.buttonY}px)`, marginTop: 15, width: '70%', maxWidth: 450 }}>了解详情</CpArrowButton>
              <div style={{height:8}} ></div>
              <CpArrowButton to={window.path+'/video/yinian.mp4'} style={{transform:`translate(0%, ${mot.buttonY}px)`, width: '70%', maxWidth:450 }}>观看影片《一念》</CpArrowButton>
              <div style={{ height: '2rem' }} />
            </div>
          </div>
        )}
